...
def main(args):
    ...
    if model == 'polar':
        logger.debug("Polar DataLoaders")
        ...
        logger.debug("Traditional DataLoaders")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--model_save_path', default='./SemKITTI_PolarSeg_exp3.pt')
