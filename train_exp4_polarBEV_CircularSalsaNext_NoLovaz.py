            ...
            if global_iter % check_iter == 0:
                ...
                with torch.no_grad():
                    for i_iter_val,(_,val_vox_label,val_grid,val_pt_labs,val_pt_fea) in enumerate(val_dataset_loader):
                        ...
                        loss = loss_fun(predict_labels.detach(),val_label_tensor)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--model_save_path', default='./SemKITTI_PolarSeg_Exp4.pt')
